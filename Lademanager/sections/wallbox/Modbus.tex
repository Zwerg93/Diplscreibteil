...
\begin{figure}[h p] \cite{7schichtenModell}
    \centering
    \includegraphics[scale=0.35]{pics/ISO-OSI-Modell-768x486.png}
    \caption{Das 7 Schichten OSI/ISO Modell}
    \label{fig:impl:Wallbox7schichtenmodell}
\end{figure}


\subsection{Modbus Protokoll}\label{modbusprotokoll}
...
\begin{table}[h p] \label{functionsfromModbus}
    \begin{tabular}{|l|l|}
    \hline
...
\subsection{Modbus RS485 vs RS232}
...
\begin{figure}[h p] \cite{modbusaufbauimg}
    \centering
    \includegraphics[scale=0.35]{pics/RS485-Schnittstelle-11.png}
