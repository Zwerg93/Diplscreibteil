...
Wenn diese Prozesse parallel ausgeführt werden, kann viel Zeit eingespart werden beziehungsweise die Performance sehr erhöht werden. Dieses Beispiel zeigt allerdings auch, dass Nebenläufigkeit gut geplant werden muss.
\cite{javaInselBuch}
...
Eine BlockingQueue hat im Regelfall einen Thread, welcher Objekte produziert und einen anderen, welcher die Objekte konsumiert. \ref{fig:impl:BlockingQueue}
